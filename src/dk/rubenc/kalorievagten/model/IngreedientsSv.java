 ...
 *
 */
@Entity( name = "IngreedientsSv")
public class IngreedientsSv implements IsSerializable, Ingreedients {

	@Id
	private Long id = new Long(1); 
	private Long origId = new Long(1);
	...
	public static IngreedientsSv getIngreedientsSv( Long id ){
		IngreedientsSv kvus = null;
		EntityManager em = EMF.get().createEntityManager();
		try{
			
			kvus = em.find(IngreedientsSv.class, id);
			//if( kvus == null ){
